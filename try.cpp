...
// int nearestPerfectSquareSqrt(int n) {
//     int sqrtVal = sqrt(n);
    
//     int lowerSquare = sqrtVal * sqrtVal;
//     int higherSquare = (sqrtVal + 1) * (sqrtVal + 1);
    
//     if (abs(n - lowerSquare) <= abs(n - higherSquare)) {
//         return sqrtVal;
//     } else {
//         return sqrtVal + 1;
//     }
